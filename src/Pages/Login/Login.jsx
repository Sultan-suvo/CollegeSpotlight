...
import { FaGoogle, FaEyeSlash, FaEye, FaGithub } from "react-icons/fa";
...
const Login = () => {
    ...
    const { signIn, signInWithGoogle, resetPassword, signInWithGithub } = useContext(AuthContext);
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex justify-center p-6">
                                <button
                                    ...
                                    className="text-sm text-orange-600 hover:text-emerald-500 focus:text-emerald-500 focus:outline-none"
                                >
                                    Forgot Password?
                                </button>
                            </div>
